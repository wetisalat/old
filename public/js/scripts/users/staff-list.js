      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var roleBadgeObj = {
              0: feather.icons['user'].toSvg({ class: 'font-medium-3 text-primary me-50' }),// Admin
              1: feather.icons['settings'].toSvg({ class: 'font-medium-3 text-warning me-50' }),//Company
              2: feather.icons['database'].toSvg({ class: 'font-medium-3 text-success me-50' }),//Staff
            ...
            return "<span class='text-truncate align-middle'>" + roleBadgeObj[$role] +' '+roleAdminObj[$role] +'</span>'
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="'+assetPath +'staff/'+full['id']+'/view/account" class="dropdown-item">' +
