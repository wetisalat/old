...
$(function () {
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ajax: assetPath + 'admin/query/plans', // JSON file to add data
      columns: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="' +
              assetPath +
              'admin/plans/'+ full["id"]+'/edit" class="dropdown-item">' +
              feather.icons['file-text'].toSvg({ class: 'font-small-4 me-50' }) +
              'Upgrade</a>' +
              '<a href="'+assetPath+'admin/'+ full["id"]+'/delete/plans" class="dropdown-item delete-record">' +
