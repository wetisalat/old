                    ...
                    render: function (data, type, full, meta) {
                        ...
                        if(full.staffArr.length > 0){
                            for (var i = 0; i < loopLength; i++) {
                                ...
                                staffHtml += '<div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom" ' +
                                    'title="'+staffFirstName + ' ' +staffLastName +' " data-bs-original-title="'+staffFirstName + ' ' +staffLastName +'" class="avatar pull-up" >' +
