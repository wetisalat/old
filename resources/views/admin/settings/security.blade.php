...
<div class="row">
  <div class="col-12">
    <ul class="nav nav-pills mb-2">
      <!-- Account -->
      <li class="nav-item">
        <a class="nav-link" href="{{asset('admin/settings')}}">
      ...
      <!-- security -->
      <li class="nav-item">
        <a class="nav-link active" href="{{asset('admin/security')}}">
...
@section('page-script')
  <!-- Page js files -->
  <script src="{{ asset(mix('js/scripts/admin/modal-two-factor-auth.js')) }}"></script>
  <script src="{{ asset(mix('js/scripts/admin/security.js')) }}"></script>
@endsection
