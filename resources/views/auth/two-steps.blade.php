  ...
  <div class="auth-inner my-2">
    ...
    <div class="card mb-0">
      <div class="card-body">
        ...
        <p class="card-text fw-bolder mb-2">{{ Auth::user()->email }}</p>

        <form class="mt-2" action="{{ route('verify.store') }}" method="POST">
            @csrf
          ...
          <div class="auth-input-wrapper d-flex align-items-center justify-content-between">
            ...
            <input type="text" class="form-control auth-input height-50 text-center numeral-mask mx-25 mb-1"
              maxlength="1" autofocus="" name="two_factor_secret[]" />

            <input type="text" class="form-control auth-input height-50 text-center numeral-mask mx-25 mb-1"
              maxlength="1" name="two_factor_secret[]" />
        ...
        <p class="text-center mt-2">
          <span>Didn’t get the code?</span><a href="{{ route('verify.resend') }}"><span>&nbsp;Resend</span></a>
          <span>or</span>
