        ...
        <div id="pricing-plan">
          ...
          <div class="row pricing-card">
            ...
            <div class="col-12 col-lg-4">
              <div class="card basic-pricing border @if ($loop->index == 1)
              border-primary
              @endif text-center shadow-none">
                <div class="card-body">
                  <img src="{{asset('images/illustration/Pot'.$loop->index + 1 .'.svg')}}" class="mb-2 mt-5" alt="svg img" />
                  <h3>{{ $plan->title }}</h3>
                  ...
                  <div class="annual-plan my-2">
                    <div class="d-flex justify-content-center plan-price">
                      ...
                      <span class="pricing-basic-value fw-bolder text-primary font-large-3 lh-1">{{ $plan->price }}</span>
                      <sub class="pricing-duration text-body font-medium-1 fw-bold mt-3">/{{ $plan->interval }}</sub>
                    </div>
                  </div>
                  ...
                  <a  href="{{ route('swapplan',['plan' => $plan->id]) }}" class="btn w-100 btn-outline-success mt-2">Swap plan</a>
                </div>
              </div>
            </div>
            <!--/ basic plan -->
