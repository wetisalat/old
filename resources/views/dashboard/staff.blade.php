...
<div class="col-lg-6 col-md-12 col-sm-12">
      <div class="row match-height">
        ...
        <div class="card-body text-center">
          ...
          <div class="text-center">
            <h1 class="mb-1 text-white">Congratulations {{ auth()->user()->firstname . ' ' .  auth()->user()->lastname }},</h1>
        ...
        <div class="card-header flex-column align-items-start pb-0">
          ...
          <h2 class="fw-bolder mt-1">{{ $total_hours_current_month}}</h2>
          <p class="card-text">Total hours current month</p>
        </div>
        ...
        <div class="card-header flex-column align-items-start pb-0">
          ...
          <h2 class="fw-bolder mt-1">{{ $total_leave_current_month }}</h2>
          <p class="card-text">Total leave current month</p>
        </div>
    ...
    <div class="col-xl-6 col-12">
      <div class="card">
        ...
        >
          <div>
            <p class="card-subtitle text-muted mb-25">Total Hours Worked</p>
            <h4 class="card-title fw-bolder total-hours-worked">{{ $total_hours_worked}}</h4>
          </div>
        ...
        <div class="card-body">
          <div class="meetup-header d-flex align-items-center">
            <div class="meetup-day">
              <h6 class="mb-0">{{ \Carbon\Carbon::now()->format('D') }}</h6>
          ...
          <div class="mt-2">
            ...
            <div class="more-info">
              ...
              <small>{{ !is_null($schedule) ? $schedule->location_name : '-' }}</small>
            </div>
          </div>
          <div class="mt-2">
            <div class="avatar float-start bg-light-primary rounded me-1">
            ...
            <div class="more-info">
              ...
              <small>{{ !is_null($schedule) ? $schedule->todo_title : '-' }}</small>
            </div>
          </div>
        </div>
      </div>
