...
<div class="modal fade" id="locationMap" tabindex="-1" aria-labelledby="locationMap" aria-hidden="true">
...
@section('page-script')
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBRbDjAmZEqpIUg9LJclblxdrFwGD7dNcw&libraries=places&callback"></script>
  <script src="{{ asset(mix('js/scripts/staff/staff_attendance.js')) }}"></script>
