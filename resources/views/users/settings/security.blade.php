...
<div class="row">
  <div class="col-12">
    <ul class="nav nav-pills mb-2">
      ...
      <!-- security -->
      <li class="nav-item">
        <a class="nav-link active" href="{{asset('settings/security')}}">
...
@section('page-script')
  <!-- Page js files -->
  <script src="{{ asset(mix('js/scripts/users/modal-two-factor-auth.js')) }}"></script>
  <script src="{{ asset(mix('js/scripts/users/security.js')) }}"></script>
@endsection
