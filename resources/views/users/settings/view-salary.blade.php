          ...
          <div class="row">
            ...
            <div class="col-xl-5 col-12">
              <dl class="row mb-0">
                ...
                <dd class="col-sm-6 mb-1">{{ isset($staff[0]->location_id)  ?  $staff[0]->staff_bonus : '' }}</dd>
              </dl>
            </div>
          </div>
          <div class="row">
            <div class="col-xl-4 col-12">
              <dl class="row mb-0">
                  <dt class="col-sm-6 fw-bolder mb-1">Weekly working time:</dt>
                  <dd class="col-sm-6 mb-1">{{ isset($staff[0]->weekly_working_time)  ?  $staff[0]->weekly_working_time : '0.00' }}€</dd>
              </dl>
            </div>
            <div class="col-xl-4 col-12">
               <dl class="row mb-0">
                  <dt class="col-sm-6 fw-bolder mb-1">Night amount:</dt>
                  <dd class="col-sm-6 mb-1">{{ isset($staff[0]->night_amount)  ?  $staff[0]->night_amount : '0.00' }}€</dd>
              </dl>
            </div>
            <div class="col-xl-4 col-12">
               <dl class="row mb-0">
                  <dt class="col-sm-6 fw-bolder mb-1">Transport amount:</dt>
                  <dd class="col-sm-6 mb-1">{{ isset($staff[0]->transport_amount)  ?  $staff[0]->transport_amount : '0.00' }}€</dd>
              </dl>
            </div>
          </div>   
        </div>
